        ...
        <div className="box-border content-stretch flex flex-col gap-16 items-start justify-center p-[80px] relative size-full">
          ...
          <div className="box-border content-stretch flex flex-col gap-12 items-start justify-start p-0 relative shrink-0 w-full">
            {services.map((service, index) => {
              ...
              return (
                <div key={service.id}>
                  <div className="box-border content-stretch flex flex-col gap-8 items-start justify-start p-0 relative shrink-0 w-[1280px]">
                    <div className="box-border content-stretch flex flex-row gap-8 items-center justify-center p-0 relative shrink-0 w-full">
                      <div className="basis-0 box-border content-stretch flex flex-row gap-8 grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
                        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-start p-[16px] relative rounded-xl shrink-0">
                        ...
                        <div className="basis-0 box-border content-stretch flex flex-col gap-3 grow items-start justify-center leading-[0] min-h-px min-w-px p-0 relative shrink-0 text-left tracking-[-0.32px]">
                          <div className="font-['Manrope',sans-serif] font-semibold relative shrink-0 text-[#ffffff] text-[32px] text-nowrap">
                            <p className="block leading-[40px] whitespace-pre">{service.title}</p>
                          </div>
                      ...
                      <div className="relative shrink-0 w-full">
                        <div className="relative size-full">
                          <div className="box-border content-stretch flex flex-row gap-16 items-start justify-start pl-24 pr-0 py-0 relative w-full">
                            <div className="basis-0 box-border content-stretch flex flex-col gap-8 grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
                              <div className="box-border content-stretch flex flex-col gap-4 items-start justify-center p-0 relative shrink-0 w-full">
                                ...
                                <div className="box-border content-stretch flex flex-row gap-6 items-start justify-start p-0 relative shrink-0 w-full">
                                  <div className="bg-[#000000] box-border content-stretch flex flex-row gap-2.5 h-40 items-end justify-center overflow-clip p-0 relative rounded-xl shrink-0 w-60">
                                    <div 
                                      className="absolute bg-center bg-cover bg-no-repeat h-[427.5px] left-0 top-[-237.5px] w-60"
                                      style={{ backgroundImage: `url('${service.caseStudy.image}')` }}
                                    />
                                  </div>
                              ...
                              <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0 pb-8">
                            ...
                            <div className="basis-0 box-border content-stretch flex flex-col gap-12 grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
